...
//            }
            ...
            view.lottieFavorite.setMinAndMaxProgress(0.0f, 1.0f)
            if (item.favorited) {
                view.lottieFavorite.setMinAndMaxFrame(0, 240)
            } else {
                view.lottieFavorite.setMinAndMaxFrame(0, 60)
            }
            view.lottieFavorite.apply {
                speed = 1.5f
                playAnimation()
            }
            view.lottieFavorite.resumeAnimation()
            view.lottieFavorite.setOnClickListener {
                movieListAdapterInterface?.onMovieFavoritedAtPosition(adapterPosition)
            }
        }
    }
